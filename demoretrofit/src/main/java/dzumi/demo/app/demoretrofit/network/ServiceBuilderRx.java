...
public class ServiceBuilderRx {

    public static DemoRetrofitServiceRx buildAPIService(Context context, String domain) {
        //view log retrofit
        ...
        return retrofit.create(DemoRetrofitServiceRx.class);
    }
